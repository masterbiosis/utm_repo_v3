                                ...
                                @foreach ($subdirectors as $subdirector)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success"
                                                href="{{ route('subdirectors.edit', ['subdirector' => $subdirector->id]) }}">Modificar</a>
                                        </td>
                                        <td>
                                            <form id="frm-borrar-{{ $subdirector->id }}" method="POST"
                                                action="{{ route('subdirectors.destroy', ['subdirector' => $subdirector->id]) }}">
                                                @csrf
                                                @method('DELETE')
