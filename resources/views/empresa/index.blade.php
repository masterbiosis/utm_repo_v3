    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <table id="empresatbl" class="table table-striped">
                            <thead>
                                <tr>
                                    <td>ID</td>
                                    <td>Nombre</td>
                                ...
                                @foreach ($empresas as $empresa)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success"
                                                href="{{ route('empresas.edit', ['empresa' => $empresa->id]) }}">Modificar</a>
                                        </td>
                                        <td>
                                            <form id="frm-borrar-{{ $empresa->id }}" method="POST"
                                                action="{{ route('empresas.destroy', ['empresa' => $empresa->id]) }}">
                                                @csrf
                                                @method('DELETE')
