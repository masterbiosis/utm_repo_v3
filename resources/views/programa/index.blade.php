                                ...
                                @foreach ($programas as $programa)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success"
                                                href="{{ route('programas.edit', ['programa' => $programa->id]) }}">Modificar</a>
                                        </td>
                                        <td>
                                            <form id="frm-borrar-{{ $programa->id }}" method="POST"
                                                action="{{ route('programas.destroy', ['programa' => $programa->id]) }}">
                                                @csrf
                                                @method('DELETE')
